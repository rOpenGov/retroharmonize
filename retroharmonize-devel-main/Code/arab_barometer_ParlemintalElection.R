...
library(tidyverse)
<<<<<<< HEAD
arabbarometer_dir <- "~/Documents/Data_Projects/retroharmonize-devel/input"
=======

arabbarometer_dir <- "input"
>>>>>>> 00b9147fd8920d3ff05ec5f22f889b8f64aad708
...
save(documented_arab_waves, file = "Arab.Rda")
#2 Desgining a metadata & merged data set for survey's rounds 
