...
ZA5913 <- ZA5913 %>%
  ...
  filter(uniqid %in% c(
    "21215396", "21215095", "21215979", "21215881", "21214003",
...
ZA6863 <- ZA6863 %>%
  ...
  filter(serialid %in% c(
    "14125", "14222", "14168", "14086", "13985", # DE-E
...
ZA7576 <- ZA7576 %>%
  ...
  filter(
    serialid %in% c(
      "13918", "14217", "14147", "14013", "14024", # DE-E
