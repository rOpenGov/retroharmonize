...
## Operating system
The retroharmonize R package depends on R version 3.5.0. [According to Microsoft](https://mran.microsoft.com/releases/3.5.0), R 3.5.0 is tested and guaranteed to run on the following platforms:
* Windows® 7.0 (SP1), 8.1, 10, Windows Server® 2008 R2 SP1, 2012 and 2016
* Ubuntu 14.04, 16.04, 18.04
* CentOS / Red Hat Enterprise Linux 6.5-6.9, 7.x
* SUSE Linux Enterprise Server 11, 12
* Mac OS X El Capitan (10.11), macOS Sierra (10.12)

In practice the retroharmonize package runs on any modern operating system.
...
[According to Microsoft](https://mran.microsoft.com/releases/3.5.0), minimum system requirements for R 3.5.0 are 64-bit processor with x86-compatible architecture, 250 MB of free disk space and at least 1 GB of RAM. 

The retroharmonize R package has passed [all tests on CRAN](https://cloud.r-project.org/web/checks/check_results_retroharmonize.html) on a [wide variety of operating systems, hardware and R versions](https://cloud.r-project.org/web/checks/check_flavors.html).
...
The retroharmonize R package depends only on R (version 3.5.0 or greater) . The package functions import functions from the following packages:
...
* R infrastructure (r-lib) packages: fs, here, pillar, rlang, tidyselect, vctrs,
