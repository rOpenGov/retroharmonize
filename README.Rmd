...
You can download the manual in [PDF](https://https://retroharmonize.dataobservatory.eu/retroharmonize_0.1.11.pdf).

## Installation

The package will be available for install via after review on [CRAN](https://CRAN.R-project.org):
