...
```
The `labelled_spss_survey()` class inherits some properties from `haven::labelled()`, which can be manipulated by the [labelled](https://CRAN.R-project.org/package=labelled) package (See particularly the vignette *Introduction to labelled* by Joseph Larmarange.)
