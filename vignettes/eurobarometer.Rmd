...
eb_trust_metadata <- metadata_surveys_create (eb_waves)
...
We cannot rely on `document_surveys()` anymore, because the result is a single data frame. Let's have a look at the descriptive metadata.
