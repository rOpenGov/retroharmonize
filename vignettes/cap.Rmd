---
title: "Creating a Harmonized Cultural Access & Participation Dataset"
...
here::here()
source(here::here("not_included", "daniel_env.R"))
gesis_dir
```
...
cap_files <- here::here(gesis_dir, c('ZA4529_v3-0-1.sav', 'ZA5688_v6-0-0.sav'))
```
