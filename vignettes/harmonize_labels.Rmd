...
```{r}
v1 <- labelled_spss_survey (c(1,0,1,9), 
                            labels = c("yes" =1,
                                       "no" = 0,
                                       "inap" = 9),
                            na_values = 9)

h1 <- harmonize_values(x = v1, 
...
Summarizing as a factor:

```{r}
summary(labelled::to_factor(h3))
```
