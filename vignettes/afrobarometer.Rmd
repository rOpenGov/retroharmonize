...
load(file = system.file(
  "examples", "afrob_vignette.rda", package = "retroharmonize"))
...
```
```{r live}
## Due to size and file permissions, the actual live example starts here. 
## You can reproduce the previous steps from the actual Afrobarometer files.
