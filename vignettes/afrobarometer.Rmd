...
attr(ab_waves[[1]], "id") <- "Afrobarometer_2012"
attr(ab_waves[[2]], "id") <- "Afrobarometer_2016"
attr(ab_waves[[3]], "id") <- "Afrobarometer_2019"
```
...
```{r check}
test_trust_president <- merged_ab[[2]]$trust_president
test_trust_president[1:20]
```
... and its code table:

```{r}
require(knitr)
document_survey_item(test_trust_president) %>%
  kable()
```
