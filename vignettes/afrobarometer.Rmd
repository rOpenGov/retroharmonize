...
Create a metadata table, or a data map, that contains information about the variable names and labels, and where each row corresponds to one variable in the survey data file. We do this with the function `metadata_create()`, which extracts the metadata from the survey data files, normalizes variable labels, identifies ranges of substantive responses and missing value codes.
